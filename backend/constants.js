const messageGuide = {
  promptGnerateInitialQuestion:
    "I'm seeking IT field career guidance and would appreciate your assistance. Please ask questions of me to understand more about me.  I'll provide my answers.Think I havent any idea what to do. Ask like these simple questions, ex: education level, interest, skills have? Ask one question at a time. The format should be question number and question. Let's start. Ask the first question.",
  promptGnerateNextQuestion:
    "Provide another question similar to the previous list for career path analysis. The question format should include the question number and question. Ask like these simple questions, ex: education level, interest, skills have? Increase the question number by one from the previous list. Provide the next question. Please provide one question at once.",
  promptAnalysis:
